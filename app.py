...
with st.sidebar:
    ...
    load_bootstrap()
    st.markdown("""<h2 style='text-align: center; color: green;'><b>
    Agricultural Advancement: A Machine Learning Crop Recommendation to Improve Crop Productivity for Enhancing Yield System
...
with coly:
    st.markdown("""
      ...
      <h6 style='text-align: center;'>
        This Application is a Machine Learning Based Crop Recommendation that give 
        recommendations to farmers based on an Crop 
        Recommendation <a style='text-align: center; color: blue;' 
        href="https://www.kaggle.com/code/prasadchaskar/crop-prediction-99-accuracy">Dataset</a>.
        ...
        to generate a recommendation of which crop to plant!
      </h6>
